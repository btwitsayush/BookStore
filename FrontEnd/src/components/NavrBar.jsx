...
function Navbar() {
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-16 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white
    ${sticky?"sticky-navbar shadow-md bg-base-300 duration-300 transition-all ease-in-out dark:bg-slate-800 dark:text-white" :""}`}>
      <div className="navbar ">
        <div className="navbar-start ">
          ...
          {/* hamburger ends */}
          <a className="text-2xl font-bold cursor-pointer ml-4 no-underline">BookStore</a>
        </div>
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            {/* search */}
            <label className="px-3 py-2 border rounded-md flex items-center gap-4 ml-4 dark:bg-white">
              <input
                type="text"
                className="grow outline-none rounded-md px-1 bg-white dark:text-black"
                placeholder="Search"
              />
              <svg
                xmlns="http://www.w3.org/2000/svg"
