...
function Buy() {
  return (
     <>
      <div className='dark:bg-slate-900 dark:text-white overflow-y-hidden'>
      <Navbar />
        <section className='max-w-screen-2xl container mx-auto  md:px-20 px-4'>
          <div className='mt-28 items-center justify-center text-center'>
            <h1 className='text-2xl font-semibold md:text-3xl'>Unlock the World of Books. <span className='text-blue-500'>Dive into Free and Premium Reads!</span></h1>
